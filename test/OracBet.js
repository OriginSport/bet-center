var OracBet = artifacts.require('./OracBet.sol')
...
contract('OracBet', accounts => {
  ...
  before(() => {
    ...
    .then(instance => {
      betCenter = instance
      return betCenter.createOracBet(...params, {gas: 4300000, from: dealer, value: 1e17})
    })
    .then(events => {
  ...
  it('should return a bet', async () => {
    const categoryBets = await betCenter.getOracBetsByCategory(params[0])
